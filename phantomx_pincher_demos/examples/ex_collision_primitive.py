...
- ros2 run phantomx_pincher_demos ex_collision_primitive.py --ros-args -p shape:="sphere" -p position:="[0.2, 0.0, 0.1]" -p dimensions:="[0.04]"
- ros2 run phantomx_pincher_demos ex_collision_primitive.py --ros-args -p shape:="cylinder" -p position:="[0.2, 0.0, -0.045]" -p quat_xyzw:="[0.0, 0.0, 0.0, 1.0]" -p dimensions:="[0.04, 0.02]"
- ros2 run phantomx_pincher_demos ex_collision_primitive.py --ros-args -p action:="remove" -p shape:="sphere"
"""
