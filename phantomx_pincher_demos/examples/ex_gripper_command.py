...
`ros2 run phantomx_pincher_demos ex_gripper_command.py --ros-args -p action:="toggle"`
`ros2 run phantomx_pincher_demos ex_gripper_command.py --ros-args -p action:="open"`
`ros2 run phantomx_pincher_demos ex_gripper_command.py --ros-args -p action:="close"`
"""
